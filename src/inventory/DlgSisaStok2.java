...
public class DlgSisaStok2 extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgSisaStok2(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgSisaStok2 dialog = new DlgSisaStok2(new javax.swing.JFrame(), true);
    ...
    private void prosesCari() {
        this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
        try {
            i=Sequel.cariInteger("select count(nm_bangsal) from bangsal_depo where status='1' ");
            ...
            htmlContent.append(                             
                "<tr class='isi'>");
            kolom=0;
            ps=koneksi.prepareStatement("select kd_bangsal,nm_bangsal from bangsal_depo where status='1' ");
            try {
                rs=ps.executeQuery();
                while(rs.next()){
